						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-body" style="padding:5px; height: 470px; overflow-y:scroll ;">
									<fieldset>
										<legend>Due/Overdue Reservations</legend>
...
<?php
$end_date=date("Y-m-d");
$sql2="SELECT * FROM reservations WHERE end_date<='$end_date' AND status!='Ended' AND status!='Cancelled' ";
...
?>
											<tr>
												<td colspan="8"><b>Total Due/Overdue Reservations: <?php echo $count2;  ?></b></td>
											</tr>
										</table>
									</fieldset>
								</div>
