...
if(isset($_SESSION['name'])){
    echo '<li><a href="profile.php"><span class="fas fa-list"></span> Reservations</a></li>
    ';
...
if(isset($_SESSION['name'])){
    ...
    <ul class="dropdown-menu">
        <li><a style="padding: 10px;" href="profile.php"><span class="fas fa-user"> Profile</a></li>
        <li><a style="padding: 10px;" href="profile.php"><span class="fas fa-list"></span> Reservations</a></li>
